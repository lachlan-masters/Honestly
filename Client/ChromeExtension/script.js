...
// // const newsapi = new NewsAPI('807678d4a7c443bb8647c18ad0aaf330');
...
// //         apikey: '2sBoCDo3iH28KmUkxkgHuIhwbnnntysy6AkEwZFZx_Cs',
// //     }),
...
//         companyNameString = cn.charAt(0).toUpperCase() + cn.slice(1);
...
//             console.log('yes supply');
//             chrome.action.setIcon({path: "/images/data_32.png"});
//         }
//     }

//     const analyseNews = (companyName) => {
//         chrome.runtime.sendMessage({name: 'analyseNews', target: companyName}, (response) => {
